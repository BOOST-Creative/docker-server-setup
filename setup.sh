...
echo "42 3 * * * docker restart fail2ban" >> /var/spool/cron/$username
...
echo 'alias boost="curl -s https://gist.githubusercontent.com/henrygd/029ccdb40563cb6891614f130a7f765c/raw > ~/.boost.sh && chmod +x ~/.boost.sh && ~/.boost.sh"' >> /home/boost/.bashrc
